	  ...
	  <div className='details-panel details-panel-bottom'>
		<div className='details-panel-container'>
		  ...
		  <div className='details-inset'>
			...
			<p>
			  npChatbot can also create a final playlist summary of your
			  streamed DJ sets, with a final tally of the songs played, their
			  average length, which songs you rocked doubles with, and more.
			</p>
			{/* <p>
