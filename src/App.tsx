			...
			<div className='download-section'>
				...
				<div className='description-box'>
					...
					<div className='description-box-text'>
						<p>
							Use the npChatbot app to connect your Twitch chat with your Serato
							Live Playlist and add a suite of interactive playlist commands to
			...
			<div className='details-panel'>
				...
				<div className='details-inset'>
					<div className='details-header'>
						Open Up A World Of Music Discovery
					</div>
					<p>
